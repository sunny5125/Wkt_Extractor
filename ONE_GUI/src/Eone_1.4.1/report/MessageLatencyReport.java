 ...
 */
public class MessageLatencyReport extends Report implements MessageListener {
	...
	@Override
	public void done() {
		write("Message Latency for scenario " + getScenarioName() + 
